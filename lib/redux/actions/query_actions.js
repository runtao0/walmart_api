...
export const changeSortByOrder = (sortByOrder) => ({
...
const createQueryUrl = ({ queryString, brandName, numResults, startAt, sortBy, sortByOrder }) => {
    ...
    if (sortByOrder) url = addSortByOrder(url, sortByOrder);
...
const addSortByOrder = (base, order) => {
